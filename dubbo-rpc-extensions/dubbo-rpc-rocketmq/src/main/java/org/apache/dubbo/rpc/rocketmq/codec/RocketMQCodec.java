...
//                        }
//                    } else {
//                        DecodeableRpcResult result = new DecodeableRpcResult(channel, res, is, (Invocation) getRequestData(channel,response,id), proto);
//                        result.decode();
//                        data = result;
//                    }
//                    res.setResult(data);
...
//                    }
//                } else {
//                    DecodeableRpcInvocation inv = new DecodeableRpcInvocation(frameworkModel, channel, req, is, proto);
//                    inv.decode();
//                    data = inv;
//                }
//                req.setData(data);
